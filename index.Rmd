...
# Abstract {-}
Este documento anliza los impactos de las variables macoreconómicas en los costos y gastos de una empresa en un determinado sector económico, para nuestro estudio seleccionamos el sector minero
