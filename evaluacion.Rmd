...
pd_datos_basicos <- read_excel("./data/datosBasicosComplete.xlsx", sheet = "Reporte", skip=8, col_types = c("text", "text", "text", "text", "text","text","text","text","text", "text","text","text","text","text","text","text","date", "text","date","text","date", "text", "text"))
